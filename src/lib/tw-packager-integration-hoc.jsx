...
const PACKAGER_URL = '/Dinosaurmod-Packager';//'https://studio.penguinmod.com/PenguinMod-Packager';
const PACKAGER_ORIGIN = window.location.origin;//"https://studio.penguinmod.com";
